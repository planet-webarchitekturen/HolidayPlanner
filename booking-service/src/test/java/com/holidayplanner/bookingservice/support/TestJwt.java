package com.holidayplanner.bookingservice.support;
 ...
 * test profile ({@code jwt.secret} default in application.yml). Claims match what
...
public final class TestJwt {
    ...
    /** Token for a random user with the given role(s). */
